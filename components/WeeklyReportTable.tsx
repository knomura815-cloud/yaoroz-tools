...
export default function WeeklyReportTable({ kpis }: WeeklyReportTableProps) {
  ...
  const rows: ReportRow[] = [
    ...
    { no: 5, label: "PPJC合計数", value: kpis.ppjcTotal, format: "count", unit: "個" },
    ...
    { no: 10, label: "皿単価", value: kpis.dishUnitPrice, format: "yen", unit: "" },
    ...
    { no: 14, label: "飲み放題獲得件数", value: kpis.nomihodaiCount, format: "count", unit: "件" },
    { no: 15, label: "飲み放題比率", value: kpis.nomihodaiRate, format: "rate", unit: "" },
    { no: 16, label: "飲み放題ドリンク単価", value: kpis.nomihodaiDrinkUnitPrice, format: "yen", unit: "" },
    { no: 17, label: "アラカルト平均ドリンク杯数", value: kpis.alacarteDrinkAvgCount, format: "decimal", unit: "杯" },
    { no: 18, label: "アラカルトドリンク単価", value: kpis.alacarteDrinkUnitPrice, format: "yen", unit: "" },
  ];
